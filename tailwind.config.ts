	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%': { boxShadow: '0 0 5px rgba(0, 160, 214, 0.5)' },
					'50%': { boxShadow: '0 0 20px rgba(0, 160, 214, 0.8)' },
					'100%': { boxShadow: '0 0 5px rgba(0, 160, 214, 0.5)' },
				},
			},
			animation: {
			...
			backgroundImage: {
				...
				'network-pattern': "url('/lovable-uploads/5ef16124-7bc5-4662-89ff-c5e80685dacb.png')",
			}
		}
	},
